...
zstyle ':completion:*:-tilde-:*' tag-order named-directories expand
zstyle ':completion:*:-tilde-:*' group-order 'named-directories' 'expand'
...
# Found this to be bugged, without it I can complete hosts fine, with I cannot
